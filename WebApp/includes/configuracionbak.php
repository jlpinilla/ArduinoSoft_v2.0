...
<div class="config-container">
    ...
    <div class="form-section">
        <h3>📡 Feed RSS</h3>
        <p>Configure el feed RSS para mostrar los datos del monitor público en tiempo real</p>
        
        <div class="alert alert-info">
            <strong>ℹ️ Información:</strong> El feed RSS muestra los mismos valores que se visualizan en el monitor público, actualizándose automáticamente
        </div>
        
        <div class="form-row">
            <div class="form-group">
                <label for="rss_url" class="form-label">📡 URL del Feed RSS</label>
                <div class="rss-url-container">
                    <input 
                        ...
                        value="<?php echo "http://" . $_SERVER['HTTP_HOST'] . dirname($_SERVER['REQUEST_URI']) . "/rss.php"; ?>"
                        readonly
                    >
                    <button type="button" onclick="copyRSSUrl()" class="btn btn-secondary copy-btn" title="Copiar URL al portapapeles">
                        📋 Copiar
                    </button>
                </div>
                <small class="form-help">URL para acceder al feed RSS con los datos del monitor público</small>
            </div>
            
            <div class="form-group">
                <label class="form-label">🔗 Información del Feed</label>
                <div class="rss-info">
                    <div class="info-item">
                        <strong>Título del Feed:</strong> <?php echo htmlspecialchars($valores['publico_titulo']); ?> - Monitor Ambiental
                    </div>
                    <div class="info-item">
                        <strong>Descripción:</strong> Datos en tiempo real de sensores ambientales - <?php echo htmlspecialchars($valores['publico_subtitulo']); ?>
                    </div>
                    <div class="info-item">
                        <strong>Datos incluidos:</strong> Temperatura, Humedad, Ruido, CO2, Iluminación
                    </div>
                    <div class="info-item">
                        <strong>Frecuencia:</strong> Actualización cada <?php echo $valores['publico_refresh_interval']; ?> segundos
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                <label class="form-label">📊 Vista Previa del Feed</label>
                <div class="rss-preview">
                    <div class="preview-header">
                        <strong><?php echo htmlspecialchars($valores['publico_titulo']); ?> - Monitor Ambiental</strong>
                    </div>
                    <div class="preview-description">
                        <?php echo htmlspecialchars($valores['publico_subtitulo']); ?> - Datos ambientales en tiempo real
                    </div>
                    <div class="preview-items">
                        <div class="preview-item">
                            <div class="item-title">🌡️ Temperatura Actual</div>
                            <div class="item-description">Último registro de temperatura de los sensores</div>
                        </div>
                        <div class="preview-item">
                            <div class="item-title">💧 Humedad Actual</div>
                            <div class="item-description">Último registro de humedad ambiental</div>
                        </div>
                        <div class="preview-item">
                            <div class="item-title">🔊 Nivel de Ruido</div>
                            <div class="item-description">Medición actual del ruido ambiental</div>
                        </div>
                        <div class="preview-item">
                            <div class="item-title">☁️ Calidad del Aire (CO2)</div>
                            <div class="item-description">Concentración actual de CO2</div>
                        </div>
                        <div class="preview-item">
                            <div class="item-title">💡 Nivel de Iluminación</div>
                            <div class="item-description">Medición actual de iluminación</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="form-label">⚙️ Acciones</label>
                <div class="rss-actions-container">
                    <a href="<?php echo "http://" . $_SERVER['HTTP_HOST'] . dirname($_SERVER['REQUEST_URI']) . "/rss.php"; ?>" 
                       target="_blank" 
                       class="btn btn-primary rss-action-btn">
                        🔗 Ver Feed RSS
                    </a>
                    <button type="button" onclick="testRSSFeed()" class="btn btn-info rss-action-btn">
                        🧪 Probar Feed
                    </button>
                </div>
                <small class="form-help">Abra el feed RSS en una nueva pestaña o pruebe su funcionamiento</small>
            </div>
        </div>
    </div>
...
.rss-action-btn.btn-primary {
    background: linear-gradient(135deg, var(--primary-color), #0056b3);
    color: white;
    box-shadow: 0 2px 8px rgba(0, 123, 255, 0.3);
}

.rss-action-btn.btn-primary:hover {
...
.rss-action-btn.btn-info {
    background: linear-gradient(135deg, #17a2b8, #138496);
    color: white;
    box-shadow: 0 2px 8px rgba(23, 162, 184, 0.3);
}

.rss-action-btn.btn-info:hover {
